 ...
 * @author hieun
 */
public class EditSupplier_Frame extends javax.swing.JFrame {

    /**
     * Creates new form AddStaff
     */
    public EditSupplier_Frame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        header_Label.setText("Chỉnh sửa thông tin nhà cung cấp");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSupplier_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditSupplier_Frame().setVisible(true);
            }
        });
    }
